package com.widyatama.nurseassistant.adapter;
...
import com.widyatama.nurseassistant.data.model.Event;
...
public class CalendarAdapter {
    ...
    public void refresh() {
        ...
        for (int i = offset; i < length + offset; i++) {
            ...
            View imgEventTag = (View) view.findViewById(R.id.img_event_tag);
