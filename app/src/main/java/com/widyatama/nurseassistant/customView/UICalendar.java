package com.widyatama.nurseassistant.customView;
...
public abstract class UICalendar extends LinearLayout {
    ...
    private Drawable mButtonLeftDrawable =
            getResources().getDrawable(R.drawable.ic_navigate_before_primary_24dp);
    private Drawable mButtonRightDrawable =
            getResources().getDrawable(R.drawable.ic_navigate_next_primary_24dp);
